...
Anything that crashes the parser, hangs the process on small input, or writes
outside the file named by `--output` is in scope. Social engineering, physical
access, and issues in third-party tooling are out of scope.
